...
function createMakeStyles(params) {
  ...
  return { makeStyles, useStyles: useStyles2 };
}
var reactContext = (0, import_react4.createContext)(void 0);
function TssCacheProvider(props) {
  const { children, value } = props;
  return import_react3.default.createElement(reactContext.Provider, { value }, children);
}
var { createUseCache } = (() => {
...
function createTss(params) {
  const { useContext: useContext2, usePlugin, cache: cacheProvidedAtInception } = params;
  const { useCache } = createUseCache({ cacheProvidedAtInception });
  const { useCssAndCx } = createUseCssAndCx({ useCache });
...
function createTss_internal(params) {
  const { useContext: useContext2, useCache, useCssAndCx, usePlugin, name, doesUseNestedSelectors } = params;
  return {
...
function GlobalStyles(props) {
  const { styles } = props;
  return import_react8.default.createElement(Global, { styles: css(styles) });
}
...
//# sourceMappingURL=chunk-33CNKWKQ.js.map
